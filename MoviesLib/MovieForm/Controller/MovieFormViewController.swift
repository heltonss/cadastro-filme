...
//  MoviesLib
//
//  Created by helton.silveira on 04/10/20.
...
final class MovieFormViewController: UIViewController {
  ...
  @IBOutlet weak var textFieldCategories: UILabel!
 ...
 @objc private func keyboardWillShow(notification:NSNotification) {
  guard let userInfo = notification.userInfo, let keyboardFrame =  userInfo[UIResponder.keyboardFrameBeginUserInfoKey] as? CGRect else { return }
